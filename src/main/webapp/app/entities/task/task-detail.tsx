    ...
    <Row>
      <Col md="8">
        <h2 data-cy="taskDetailsHeading">
          <Translate contentKey="nilanApp.task.detail.title">Task</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="title">
              <Translate contentKey="nilanApp.task.title">Title</Translate>
            </span>
          </dt>
          ...
          <dt>
            <Translate contentKey="nilanApp.task.job">Job</Translate>
          </dt>
          <dd>
            {taskEntity.jobs
